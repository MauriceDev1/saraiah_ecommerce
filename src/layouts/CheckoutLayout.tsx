            ...
            <div class="w-full lg:w-2/3 m-auto p-5 md:h-[82vh] bg-customColor border border-gray-300 rounded-sm">
                ...
                <div class="w-full flex md:gap-5 flex-wrap md:flex-nowrap">
                    <div class="w-full md:w-1/2 flex flex-col gap-1">
                        ...
                        <div>
                            <For each={cart()}>{
                                (i) => <div class="w-full border rounded-sm flex py-1 bg-white items-center">
                    ...
                    <div class="w-full md:w-1/2 flex flex-col gap-1 relative md:h-[73vh]">
                        ...
                        {locationList().length > 0 
                            ?
                                <select
                                    ...
                                    class="w-full max-w-[450px] h-10 border border-gray-300 outline-none px-1"
                                >
                        ...
                        <input 
                            ...
                            class="w-full max-w-[450px] h-10 border border-gray-300 px-2"
                        />
                        <div>
                        ...
                        <textarea 
                            ...
                            class="border border-gray-300 resize-none rounded-sm p-2"
                        ></textarea>
                        <button
